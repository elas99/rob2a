...
task main()
{
  wait1Msec(10000);        // Wait 2000 milliseconds before continuing.
	int x;
  int i;
  for(i=0; i<16; i++)      // While 'i' is less than 4:
  {
  	if(i % 3 == 0){
    Forward(i);         // Call function 'Forward(float)' and pass the float value '3.0' through.
    Backward(i);				// Call function 'TurnLeft(float)' and pass the float value '1.3' through.
    }
  }
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
